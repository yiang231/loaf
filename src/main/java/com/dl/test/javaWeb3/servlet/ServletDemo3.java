...
import com.dl.test.javaWeb3.listener.HttpSessionActivationListenerDemo;
import com.dl.test.javaWeb3.listener.HttpSessionBindingListenerDemo;
...
public class ServletDemo3 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("ServletDemo3 处理POST请求");
        // POST请求乱码解决
        ...
        System.out.println(req.getServerPort()); // 端口号
        System.out.println(req.getServerName()); // 主机名
        System.out.println(req.getScheme()); // 协议

        // 请求头
        System.out.println(req.getHeader("User-Agent"));
        System.out.println(req.getHeader("Referer")); // 上个页面的地址
...
//		req.getRequestDispatcher("password.jsp").forward(req, resp);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("ServletDemo3 处理GET请求");
