...
public class DynamicEnumUtils {
	...
	public static void main(String[] args) {
		...
		addEnum(EnumConstDemoTest3.class, "JOKER", new Class[]{Class.class, String.class}, new Object[]{Joker.class, "Joker"});

		log.info("增加后当前所有的枚举项");
		for (EnumConstDemoTest3 value : EnumConstDemoTest3.values()) {
			log.info(value.name());
		}
		log.info("{}", Monster.getInstance("JokEr"));
	}
}
