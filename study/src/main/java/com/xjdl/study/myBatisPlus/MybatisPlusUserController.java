...
//        mybatisPlusUserMapper.selectOne(queryWrapper);// 查到的数据最多就一行
    ...
    public ResultResponse selectAll() {
        ...
        <==      Total: 16
        */
        List<MybatisPlusUser> selectAll = mybatisPlusUserMapper.selectAll();
        return ResultResponse.success(selectAll);
    }

    @Test
    void lambda1() {
        // fixme Invalid bound statement (not found): com.xjdl.study.myBatisPlus.MybatisPlusUserService.getBaseMapper
